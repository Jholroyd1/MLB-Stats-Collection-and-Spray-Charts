...
# Field geometry (no rotation needed)
...
# Statcast: x toward 3B (left), y toward CF (up)
plot_x = -data['coord_x']
plot_y = data['coord_y']
...
plt.savefig('../data/ohtani_2025_spraychart_final.png', dpi=300, bbox_inches='tight', pad_inches=0.05)
plt.show()
