...
# Shift so minimum y is at 0 (home plate)
plot_y_shifted = plot_y - plot_y.min()

# Highlight home runs
is_hr = data['event_type'].str.lower().str.contains('home_run')
ax.scatter(plot_x, plot_y_shifted, color='red', edgecolors='black', s=60, zorder=20, alpha=0.7, label='All batted balls')
ax.scatter(plot_x[is_hr], plot_y_shifted[is_hr], color='gold', edgecolors='black', s=80, zorder=21, label='Home runs')
...
plt.savefig('../data/ohtani_2025_spraychart_aligned.png', dpi=300, bbox_inches='tight', pad_inches=0.05)
plt.show()
