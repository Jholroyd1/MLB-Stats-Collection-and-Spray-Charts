...
# Statcast: x is toward 3B (left), y is toward CF (up)
# To match field, flip x axis
plot_x = -data['coord_x']
plot_y = data['coord_y']
...
ax.axis('off')
plt.tight_layout()
plt.savefig('../data/ohtani_2025_spray_chart_on_field_fixed.png', dpi=300, bbox_inches='tight', pad_inches=0.05)
plt.show()
